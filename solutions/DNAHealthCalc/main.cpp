...
public:
    ...
    void AddString(string s, int wordID, int healthVal)
    {
        int curVertex = root;
        ...
        // Add genes id and genes health value
        Trie[curVertex].WordID.push_back(wordID);
        Trie[curVertex].HealthValue.push_back(healthVal);
